        ...
        <main class="col-md-9 col-lg-10 arquivo-page">
            ...
            <div class="summary-grid">
                <div class="summary-card primary">
                    ...
                    <div class="summary-help">Equipamentos fora da utilização ativa</div>
                </div>
                <div class="summary-card info">
                    ...
                    <div class="summary-help">Tipos de equipamento no arquivo</div>
                </div>
                <div class="summary-card warning">
                    ...
                    <div class="summary-help">Locais com equipamentos inativos</div>
                </div>
                <div class="summary-card danger">
                    <i class="fas fa-euro-sign summary-icon"></i>
                    <div class="summary-label">Valor de aquisição</div>
                    <div class="summary-value"><?= h(moeda_arquivo($resumo['valor'])) ?></div>
                    <div class="summary-help">Soma dos custos dos inativos</div>
                </div>
            </div>
