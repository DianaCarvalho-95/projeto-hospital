...
<head>
    ...
    <title>Novo Documento - MedTech Solutions</title>
...
<body>
    ...
    <main class="content">
        <div class="form-wrapper">
            <h2><strong><i class="fa-solid fa-file-medical"></i> Inserir novo documento</strong></h2>
            <hr>
            ...
            <form action="#" method="post" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="data_documento" name="data_documento">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="ficheiro" name="ficheiro">
                </div>
                ...
                <div class="form-buttons">
                    ...
                    <button type="submit"><i class="fa-regular fa-floppy-disk"></i> Guardar</button>
                </div>
